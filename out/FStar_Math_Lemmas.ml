...
let mul_binds_tighter: Prims.int -> Prims.int -> Prims.int -> Prims.unit =
  fun a  -> fun b  -> fun c  -> ()
let mul_ineq1: Prims.int -> Prims.nat -> Prims.int -> Prims.nat -> Prims.unit
...
let rec pow2_plus: Prims.nat -> Prims.nat -> Prims.unit =
  fun n  -> fun m  -> ()
let pow2_minus: Prims.nat -> Prims.nat -> Prims.unit = fun n  -> fun m  -> ()
...
let lemma_mod_plus_injective:
  Prims.pos -> Prims.nat -> Prims.nat -> Prims.nat -> Prims.unit =
  fun p  -> fun a  -> fun b  -> fun c  -> ()
let lemma_mod_plus_distr_l: Prims.nat -> Prims.nat -> Prims.pos -> Prims.unit
  = fun a  -> fun b  -> fun p  -> ()
