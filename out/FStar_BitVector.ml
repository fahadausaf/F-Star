...
let zero_vec: Prims.pos -> Prims.bool FStar_Seq_Base.seq =
  fun n  -> FStar_Seq_Base.create n false
let elem_vec: Prims.pos -> Prims.nat -> Prims.bool FStar_Seq_Base.seq =
  fun n  ->
    fun i  -> FStar_Seq_Base.upd (FStar_Seq_Base.create n false) i true
let ones_vec: Prims.pos -> Prims.bool FStar_Seq_Base.seq =
  fun n  -> FStar_Seq_Base.create n true
let rec logand_vec:
  Prims.pos ->
    Prims.unit bv_t -> Prims.unit bv_t -> Prims.bool FStar_Seq_Base.seq
  =
  fun n  ->
    fun a  ->
      fun b  ->
        ...
        then
          ...
          FStar_Seq_Base.append
            ...
            (logor_vec (n - (Prims.parse_int "1"))
               ...
               (FStar_Seq_Base.slice b (Prims.parse_int "1") n))
let rec lognot_vec:
  Prims.pos -> Prims.unit bv_t -> Prims.bool FStar_Seq_Base.seq =
  fun n  ->
    fun a  ->
      if n = (Prims.parse_int "1")
      then
