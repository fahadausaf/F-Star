...
let raise uu____687 = failwith "Not yet implemented:raise"
...
type ('Aheap,'Aa,'Ax,'Ap,'Auu____783) all_return = 'Ap
...
let allow_inversion = ()
let invertOption uu____1026 = ()
type ('a,'b) either =
  | Inl of 'a
  | Inr of 'b
let uu___is_Inl projectee =
  match projectee with | Inl v -> true | uu____1065 -> false
let __proj__Inl__item__v projectee = match projectee with | Inl v -> v
let uu___is_Inr projectee =
  match projectee with | Inr v -> true | uu____1109 -> false
